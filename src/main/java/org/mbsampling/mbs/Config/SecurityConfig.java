package org.mbsampling.mbs.Config;

import org.mbsampling.mbs.Filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(
                        req->req.requestMatchers("/login/**","/register/**", "/refresh_token/**", "/forgotpassword")
                                .permitAll()
